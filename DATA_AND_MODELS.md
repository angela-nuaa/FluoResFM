...
| 资源 | 本地目录 | 权威来源 | 处理规则 |
| --- | --- | --- | --- |
| 示例训练/测试数据 | `example/data/` | [Zenodo 18382702](https://doi.org/10.5281/zenodo.18382702) | 下载后保留原始压缩包校验和与许可信息；不提交。 |
| FluoResFM 与 BiomedCLIP 权重 | `example/checkpoints/` | [Zenodo 18382702](https://doi.org/10.5281/zenodo.18382702) | 不提交；实验记录中注明下载日期、文件名、SHA-256 与许可。 |
